...
const mockData: AppData = {
  users: [
    { telegram_id: '1', username: 'ivan_sadhu', name: 'Иван', photo: 'https://picsum.photos/seed/1/100', created_at: new Date().toISOString() },
    { telegram_id: '2', username: 'masha_om', name: 'Мария', photo: 'https://picsum.photos/seed/2/100', created_at: new Date().toISOString() },
  ],
  sessions: [
    { session_id: 's1', telegram_id: '1', date: new Date().toISOString(), duration_seconds: 600, intention: 'Спокойствие', mood: '🙂' },
    { session_id: 's2', telegram_id: '2', date: new Date().toISOString(), duration_seconds: 300, intention: 'Энергия', mood: '😐' },
  ],
  live_sessions: [
    { telegram_id: '1', start_time: new Date(Date.now() - 272000).toISOString(), intention: 'Глубокая медитация' }
  ],
};
