          ...
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              <div className="space-y-2">
                <h3 className="text-2xl font-bold">Твое намерение?</h3>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 bg-zinc-800 rounded-2xl font-bold"
                >
                  Отмена
                </button>
                <button
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 p-4 rounded-2xl transition-transform active:scale-95 ${m.color}`}
                  >
                    {m.icon}
